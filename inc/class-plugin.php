...
final class Plugin {
	...
	public function activate(): void {
		OrganizationPostType::register();
		OrganizationTaxonomy::register();
		// phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.flush_rewrite_rules_flush_rewrite_rules
		flush_rewrite_rules();
	}

	public function deactivate(): void {
		OrganizationTaxonomy::unregister();
		OrganizationPostType::unregister();
		// phpcs:ignore WordPressVIPMinimum.Functions.RestrictedFunctions.flush_rewrite_rules_flush_rewrite_rules
		flush_rewrite_rules();
	}
	...
	public function init(): void {
		add_image_size( 'organization-thumbnail', 350, 350, true );
